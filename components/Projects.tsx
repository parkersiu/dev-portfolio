...
export default function Projects({ projects }: Props) {
  return (
    <motion.div
      ...
      className="h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0 pt-0 md:pt-10"
    >
        ...
        {projects?.map((project, i) => (
          ...
          >
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="italic text-sm text-gray-300/70 md:text-lg md:text-left">
                {project?.summary}
              </p>
            </div>
          </div>
